...
window.SITE = {
    ...
    seo: {
        ...
        description: "Ethan Blair: programmer focused on enterprise technology, automation, and AI development.",
        ogType: "website",
        twitterCard: "summary",
    ...
    publishedWork: {
        ...
        emptyMessage: "No published papers configured yet. Add DOI entries in config.js.",
        items: [
            // Example:
            // {
            //     doi: "10.xxxx/xxxxx",
